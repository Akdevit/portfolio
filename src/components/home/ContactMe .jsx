    ...
    return (
        <>
            <div className='w-full h-auto flex flex-col lg:flex-row'>
                {/* Image Section */}
                <div ref={imageRef} className='w-full lg:w-[50%] h-full lg:h-full p-8'>
                    <img src={Startup} alt='background' className='w-full h-full object-cover' />
                </div>

                {/* Form Section */}
                <div ref={formRef} className='w-full lg:w-[50%] h-auto lg:h-full flex flex-col gap-4 items-center justify-center p-8'>
                    <h1 className='text-4xl font-bold h1textcontact'>Contact Me</h1>
                    <p className='text-lg text-center'>Feel free to get in touch for any project inquiries, collaborations, or questions.</p>

                    <div className='w-full lg:w-[60%] mt-12 rounded-lg'>
                        {/* Full Name */}
